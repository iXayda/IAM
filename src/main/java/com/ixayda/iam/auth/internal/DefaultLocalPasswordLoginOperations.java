...
class DefaultLocalPasswordLoginOperations implements LocalPasswordLoginOperations {
	...
	DefaultLocalPasswordLoginOperations(UserOperations users, PasswordOperations passwords, SessionOperations sessions,
	...
	@Override
	@Transactional
	public LocalPasswordLoginResult login(TenantId tenantId, LoginKey loginKey, PasswordAttempt password) {
		...
		if (user == null || !user.isActive()) {
			...
			return LocalPasswordLoginResult.failure();
		}
