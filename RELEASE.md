...
5. SCIM discovery、租户隔离的 User 生命周期与 Group 单资源读取、service JWT read/write 边界、OAuth 2.0 Authorization Code、PKCE、OIDC、Refresh Token 和 Client Credentials HTTP smoke；
